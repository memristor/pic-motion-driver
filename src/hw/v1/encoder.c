...
int encoder_motor_left_get_velocity(void){return 0;}
int encoder_motor_right_get_velocity(void){return 0;}

int encoder_odometry_left_get_count(void) {return 0;}
int encoder_odometry_right_get_count(void) {return 0;}
int encoder_motor_left_get_count(void){return 0;}
int encoder_motor_right_get_count(void){return 0;}
